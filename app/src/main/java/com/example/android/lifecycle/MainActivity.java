...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (5) Put the text from the TextView in the outState bundle
        String lifecycleDisplayTextViewComments = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, lifecycleDisplayTextViewComments);
    }
    /**
